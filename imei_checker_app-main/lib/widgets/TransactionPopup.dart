...
class TransactionPopup extends StatelessWidget {
  ...
  TransactionPopup({Key? key,required this.invoiceModel}) : super(key: key);
  ...
  Widget _buildInvoiceDetails() {
    return Column(
      ...
      mainAxisSize: MainAxisSize.min,
      children: [
        Text('Status: ${invoiceModel?.status}',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
